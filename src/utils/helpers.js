...
export const ZONE_LABELS = {
  trote: 'Trote (50–60%)',
  z0: 'Z0 – Regenerativo (60–70%)',
  z1: 'Z1 – Aeróbico Base (70–80%)',
  z2: 'Z2 – Endurance (80–88%)',
  z3: 'Z3 – Intensivo (88–95%)',
  z4: 'Z4 – Limiar (95–100%)',
  z5: 'Z5 – VO2 (100–108%)',
  z6: 'Z6 – Anaeróbio (108–120%)',
};

export const DEFAULT_ZONE_CONFIG = [
  { key: 'trote', name: 'Trote',        color: '#475569', low: 50,  high: 60  },
  { key: 'z0',    name: 'Regenerativo', color: '#94A3B8', low: 60,  high: 70  },
  { key: 'z1',    name: 'Aeróbico Base',color: '#60A5FA', low: 70,  high: 80  },
  { key: 'z2',    name: 'Endurance',    color: '#34D399', low: 80,  high: 88  },
  { key: 'z3',    name: 'Intensivo',    color: '#FBBF24', low: 88,  high: 95  },
  { key: 'z4',    name: 'Limiar',       color: '#F97316', low: 95,  high: 100 },
  { key: 'z5',    name: 'VO2',          color: '#EF4444', low: 100, high: 108 },
  { key: 'z6',    name: 'Anaeróbio',    color: '#7C3AED', low: 108, high: 120 },
];
