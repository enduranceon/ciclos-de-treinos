...
🟢 PRIORIDADE 1 — Subzonas de Precisão
   ...
   Endurance Leve        80–84%       z2           "endurance leve"
   Endurance Extensivo   84–88%       z2           "moderado", "conversação", "rodagem", "endurance extensivo"
   Endurance Intensivo   88–92%       z3           "endurance intensivo", "sustentado", "maratona"
   Sub Limiar            92–95%       z3/z4        "sub limiar", "sub-limiar", "abaixo do limiar"
   Limiar                97–100%      z4           "limiar", "threshold", "LT2", "tempo run"
   VO2                   100–108%     z5           "vo2max", "vo2", "crítico"
   Anaeróbio             108–120%     z6           "anaeróbio", "potência", "sprint", "neuro"
   Trote                 50–60%       trote        "trote", "regenerativo", "caminhada"
...
Qualificadores alto/baixo — ativam subzona mesmo com código de zona:
  ...
  "z2 baixo" → Endurance Leve     (80–84%)  | JSON zone: z2
  "z2 alto"  → Endurance Extensivo(84–88%)  | JSON zone: z2
  "z3 baixo" → Endurance Intensivo(88–92%)  | JSON zone: z3
  "z3 alto"  → Sub Limiar         (92–95%)  | JSON zone: z3
  "z4 baixo" → Sub Limiar         (92–95%)  | JSON zone: z4  ← MESMO range que "z3 alto"
  "z4 alto"  → Limiar             (97–100%) | JSON zone: z4

⚠️ REGRA CRÍTICA DE SINONÍMIA: "z3 alto" e "z4 baixo" são IDÊNTICOS — ambos = Sub Limiar (92–95%).
...
⚠️ NOTAÇÃO zN/zN+1 EM BLOCO CONTÍNUO — cruzamento de zonas adjacentes = subzona:
   ...
   z2/z3  ou  z3/z2  → Endurance Intensivo(88–92%)   | zone: z3 | targetLow:88 targetHigh:92
   z3/z4  ou  z4/z3  → Sub Limiar         (92–95%)   | zone: z3 | targetLow:92 targetHigh:95
   z4/z5  ou  z5/z4  → VO2               (100–108%)  | zone: z5 | targetLow:100 targetHigh:108

   Exemplos diretos:
     "8km contínuos z1/z2"  → título: "Aeróbico Base"   | 8km · 70-80%
     "10km z3/z4"           → título: "Sub Limiar"       | 10km · 92-95%
...
Tabela de ranges por subzona (para preencher targetLow/targetHigh):
  ...
  Endurance Leve     → targetLow:80, targetHigh:84  | zone: z2
  Endurance Extensivo→ targetLow:84, targetHigh:88  | zone: z2
  Endurance Intensivo→ targetLow:88, targetHigh:92  | zone: z3
  Sub Limiar         → targetLow:92, targetHigh:95  | zone: z3 ou z4
